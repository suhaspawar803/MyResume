          ...
          <div class="card">
            ...
            if ($_POST) {
              ...
              if ($db) {
               ...
               $sql2 = "SELECT sr_no FROM Student_competition_info WHERE sname='$sname' AND comp_date='$date';";
              }
              ...
              if (!$db) {
                ...
                if (!$ret) {
                  ...
                  $num = pg_fetch_row($ret);
                  move_uploaded_file($_FILES['file']['tmp_name'],"../../assets/images/certificates/img".$num[0]);
            ...
            //     move_uploaded_file($_FILES['file']['tmp_name'],"images/img1.jpg");
