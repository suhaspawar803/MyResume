        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              ...
              <a href="../forms/Sport_Activity.php"><input class="btn btn-primary mr-2" type="button" value="Add Data" /></a>
              <a href="../utility/recent_record.php"><input class="btn btn-primary mr-2" type="button" value="Verify Record" /><br><br>
